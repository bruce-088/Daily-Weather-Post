  ...
  return {
    ...
    elements: [
      ...
      },
      {
        ...
        x: "50%",
        y: "30%",
        fill_color: "rgba(56, 189, 248, 0.08)",
        animations: [
          { type: "scale", start_scale: "80%", end_scale: "120%", duration: 8, easing: "linear" },
        ],
      },
      {
        type: "shape",
        ...
        x: "30%",
        y: "70%",
        fill_color: "rgba(99, 102, 241, 0.06)",
        animations: [
          { type: "scale", start_scale: "100%", end_scale: "140%", duration: 8, easing: "linear" },
        ],
      },
      {
        type: "text", track: 4, time: 0, duration: 8,
        text: "SkyBrief", font_family: "Inter", font_weight: "700", font_size: "42",
        fill_color: "#38bdf8", x: "50%", y: "8%", x_alignment: "50%", y_alignment: "50%",
        enter: { type: "fade", duration: 0.5 },
      },
      {
        type: "text", track: 5, time: 0.3, duration: 7.7,
        text: `${weather.city}, ${weather.stateOrRegion}`,
        font_family: "Inter", font_weight: "700", font_size: "58",
        fill_color: "#ffffff", x: "50%", y: "17%", x_alignment: "50%", y_alignment: "50%",
        enter: { type: "slide", direction: "up", duration: 0.6 },
      },
      {
        type: "text", track: 6, time: 0.5, duration: 7.5,
        text: dateStr, font_family: "Inter", font_weight: "400", font_size: "32",
        fill_color: "#94a3b8", x: "50%", y: "23%", x_alignment: "50%", y_alignment: "50%",
        enter: { type: "fade", duration: 0.5 },
      },
      {
        type: "text", track: 7, time: 0.8, duration: 7.2,
        text: `${weather.temperature}°F`,
        font_family: "Inter", font_weight: "800", font_size: "120",
        fill_color: "#ffffff", x: "50%", y: "36%", x_alignment: "50%", y_alignment: "50%",
        enter: { type: "scale", start_scale: "50%", duration: 0.6 },
      },
      {
        type: "text", track: 8, time: 1.0, duration: 7.0,
        text: weather.condition, font_family: "Inter", font_weight: "500", font_size: "44",
        fill_color: "#e2e8f0", x: "50%", y: "45%", x_alignment: "50%", y_alignment: "50%",
        enter: { type: "fade", duration: 0.5 },
      },
      {
        type: "shape", track: 9, time: 1.3, duration: 6.7,
        shape_type: "rectangle", width: 600, height: 2, x: "50%", y: "51%",
        fill_color: "rgba(148, 163, 184, 0.3)",
        enter: { type: "scale", start_scale: "0%", duration: 0.4 },
      },
      {
        type: "text", track: 10, time: 1.5, duration: 6.5,
        text: morningLine, font_family: "Inter", font_weight: "500", font_size: "36",
        fill_color: "#cbd5e1", x: "50%", y: "57%", x_alignment: "50%", y_alignment: "50%",
        enter: { type: "slide", direction: "right", duration: 0.5 },
      },
      {
        type: "text", track: 11, time: 1.8, duration: 6.2,
        text: afternoonLine, font_family: "Inter", font_weight: "500", font_size: "36",
        fill_color: "#cbd5e1", x: "50%", y: "63%", x_alignment: "50%", y_alignment: "50%",
        enter: { type: "slide", direction: "right", duration: 0.5 },
      },
      {
        type: "text", track: 12, time: 2.1, duration: 5.9,
        text: eveningLine, font_family: "Inter", font_weight: "500", font_size: "36",
        fill_color: "#cbd5e1", x: "50%", y: "69%", x_alignment: "50%", y_alignment: "50%",
        enter: { type: "slide", direction: "right", duration: 0.5 },
      },
      {
        type: "text", track: 13, time: 2.5, duration: 5.5,
        text: `🌧 Rain: ${weather.rainChance}%   💨 Wind: ${weather.windInfo}`,
        font_family: "Inter", font_weight: "400", font_size: "30",
        fill_color: "#94a3b8", x: "50%", y: "78%", x_alignment: "50%", y_alignment: "50%",
        enter: { type: "fade", duration: 0.5 },
      },
      {
        type: "text", track: 14, time: 2.8, duration: 5.2,
        text: `🌅 ${weather.sunrise}  •  🌇 ${weather.sunset}`,
        font_family: "Inter", font_weight: "400", font_size: "30",
        fill_color: "#94a3b8", x: "50%", y: "84%", x_alignment: "50%", y_alignment: "50%",
        enter: { type: "fade", duration: 0.5 },
      },
      {
        type: "text", track: 15, time: 3.5, duration: 4.5,
        text: "Follow @SkyBrief for daily updates",
        font_family: "Inter", font_weight: "500", font_size: "28",
        fill_color: "#38bdf8", x: "50%", y: "93%", x_alignment: "50%", y_alignment: "50%",
